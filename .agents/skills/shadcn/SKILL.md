...
- **`isRSC`** → when `true`, components using `useState`, `useEffect`, event handlers, or browser APIs need `` at the top of the file. Always reference this field when advising on the directive.
