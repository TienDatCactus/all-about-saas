...
/** Fire the nearest <Confetti> canvas from anywhere inside it. */
export function useConfetti(): ConfettiRef {
  const context = useContext(ConfettiContext)
  if (!context) {
    throw new Error("useConfetti must be used within a <Confetti>")
  }
  return context
}
